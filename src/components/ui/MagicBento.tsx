...
export interface ServiceBentoProps {
  services: ServiceBentoCardProps[]; // Recibe el array de servicios
  textAutoHide?: boolean;
  enableStars?: boolean;
...
const getCategoryColor = (category: string) => {
  switch (category) {
    case 'impresion': return '#cbc516ff'; // blue-800
    case 'laser': return '#ff0909ff'; // red-600
    case 'papeleria': return '#1de6dfff'; // emerald-600
    default: return '#6b7280'; // gray-500
  }
};

// Función para obtener el label según la categoría
...
const MagicServicesBento: React.FC<ServiceBentoProps> = ({
  services, // Ahora recibe los servicios como prop
  textAutoHide = true,
  enableStars = true,
      ...
      <BentoCardGrid gridRef={gridRef}>
        {services.map((service, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: service.color || "#060010",
...
export default MagicServicesBento;